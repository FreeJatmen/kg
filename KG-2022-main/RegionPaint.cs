...
namespace Lab1_kg_
{
    internal class RegionPaint
    {
        ...
        private RegionMap ComputeMask(Bitmap image, int thr)
        {
            ...
            for (int y = 0; y < image.Height; y++)
                for (int x = 0; x < image.Width; x++)
                {
                    int pixI = Tools.GetBrightness(image.GetPixel(x, y));
    ...
    internal class RegionMap
    {
        ...
        public string MetadataPerimeter()
        {
            ...
            foreach (var r in _regionList)
            {
                RetMes += "Reg" + r.Id + " P = " + RegionP.RegionPerimeter(r) + "\n";
            }
            return RetMes;
        }
        ...
        public string MetadataSquare()
        {
            ...
            foreach (var r in _regionList)
            {
                RetMes += "Reg" + r.Id + " S = " + RegionP.RegionSquare(r) + "\n";
            }
            return RetMes;
        }
        ...
        public string MetadataMomentum()
        {
            ...
            foreach (var r in _regionList)
            {
                RetMes += "Reg" + r.Id + " M = " + RegionP.RegionDiscreteMomentum(r, i, j, _sourceImage) + "\n";
            }
            return RetMes;
        }
